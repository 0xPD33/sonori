...
impl Slider {
    ...
    pub fn render_at(
        ...
        // Collect label text item. Overlay widgets are drawn above this row rather
        // than asking the row to hide parts of itself.
        ...
        // Draw handle
        let handle_x = self.value_to_x(self.value);
        let handle_y = y + self.height / 2.0;
